									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="text" class="form-control"
													name="res_sub" value="${dto.res_sub }" /></td>
											</tr>
											<tr>
												<th class="text-center" style="vertical-align: middle;">예약날짜</th>
												<td><input type="text" class="form-control"
													name="res_date" value="${dto.res_date }" /></td>
											...
											<tr>
												...
												<td colspan="3" style="height: 150px;"><textarea
														rows="10" class="form-control" name="res_note">${dto.res_note }</textarea>
												</td>
											</tr>
										</tbody>
									</table>
