			...
			<div class="inner">
				...
				<article class="contents snb-none">
					...
					<div class="tit-tableWrap mar-t30">
						...
						<p class="essential">
							<em class="emphasis-red">* 필수입력사항</em>입니다.
						</p>
					</div>
								...
								<tbody>
									<tr>
										...
										<td style="text-align: left;"><input type="text"
											name="name" value="${dto.mem_name }" class="join_input" /></td>
									</tr>
									<tr>
										<th>성별</th>
									...
									<tr>
										<th>아이디</th>
										<td style="text-align: left;"><input type="text"
											name="id" value="${dto.mem_id }" class="join_input" /></td>
									</tr>
									<tr>
										<th>비밀번호</th>
										<td style="text-align: left;"><input type="password"
											name="pass" value="${dto.mem_pass }" class="join_input" style="width: 300px;" /></td>
									</tr> 
									<tr>
										<th>관심질병</th>
