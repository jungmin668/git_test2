    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("tkaqkeldk"); // SMS아이디
        String secure = base64Encode("a6785795d75d91cb2dfa29c7d96c09cd");//인증키
        ...
        for (int i=0;i<arrKey.length; i++)
        {
       	...
       	if(request.getParameter("rphone").replaceAll("-","").length() < 8 || request.getParameter("rphone").replaceAll("-","").length() > 11 ||
       			request.getParameter("rphone").charAt(0) != '0'){
       		out.println("<script>alert('핸드폰 번호를 바르게 입력해주세요.!')</script>");
       	}else{
    ...
    response.sendRedirect("../reserve/resList");
    %>
